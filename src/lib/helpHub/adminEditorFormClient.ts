...
function readFormValues(
  ...
  return {
    ...
    mediaUrl: fieldValue(form, "mediaUrl").trim(),
    mediaAlt: fieldValue(form, "mediaAlt").trim(),
    mediaCaption: fieldValue(form, "mediaCaption").trim(),
    relatedToolLabel: fieldValue(form, "relatedToolLabel").trim(),
