...
describe("Course 86 lesson 4233 exercise accordion answers", () => {
  ...
  it("makes each What happens? control open only its own recovered answer", () => {
    ...
    expect(presented[1]!.html).toContain("/images/course-content/86/arrow2.png");
    expect(presented[1]!.html).not.toContain("/challenge/images/arrow2.png");
    expect(presented[3]!.html).toContain("/images/course-content/86/arrow4.png");
    expect(presented[4]!.html).toContain("/images/course-content/86/arrow5.png");
