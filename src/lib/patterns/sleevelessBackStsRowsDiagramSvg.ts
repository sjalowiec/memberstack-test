/**
 * Generated Stitches & Rows SVG for Sleeveless Back (straight body).
 *
...
export function buildSleevelessBackStsRowsDiagramSvg(
  ...
  const parts = [drawSilhouette(frame), drawMeasurements(model, frame)];
