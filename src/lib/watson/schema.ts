...
WHERE revoked_at IS NULL AND memberstack_id IS NULL`,
  ...
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
    ...
    {
      label: "table watson_contact_messages",
      sql: `CREATE TABLE IF NOT EXISTS watson_contact_messages (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ...
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
    ...
    {
      label: "index idx_watson_contact_messages_status_created",
      sql: "CREATE INDEX IF NOT EXISTS idx_watson_contact_messages_status_created ON watson_contact_messages (status, created_at DESC)",
    },
    {
      label: "index idx_watson_contact_messages_created",
      sql: "CREATE INDEX IF NOT EXISTS idx_watson_contact_messages_created ON watson_contact_messages (created_at DESC)",
    },
    {
