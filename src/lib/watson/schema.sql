...
CREATE INDEX IF NOT EXISTS idx_watson_legacy_customers_email ON watson_legacy_customers (LOWER(email));

CREATE INDEX IF NOT EXISTS idx_watson_legacy_customers_name ON watson_legacy_customers (last_name, first_name);
